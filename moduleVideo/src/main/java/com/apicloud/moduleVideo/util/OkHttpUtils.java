...
public class OkHttpUtils
{
    ...
    public static void customAsyncExecuteWithFile(final Activity activity, String url, File file, boolean needToken, final DataView dataView, final String mRequestTag)
    {
...
//                        activity.dismissProgressDialog();
    ...
    {
        // 个人信息编辑
        public static void ModifyPhoto(final Activity activity, final String apiurl, final String filePath, final boolean needAddToken, final DataView dataView, final String requestTag)
        {
            new Thread()
            {
                @Override
        ...
        public static void doUploadPhoto(final Activity activity, final String apiurl, String filePath, boolean needAddToken, final DataView dataView, final String requestTag)
        {
            try
            {
